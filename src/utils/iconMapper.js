...
const iconMap = {
  ...
  finance_reports: IconCash,
  production_schedule: IconCalendarEvent,
  calendar_month: IconCalendarEvent,
  cost_sheet: IconReceipt2,
  calculator: IconReceipt2,
  assembly: IconTools,
  clipboard: IconClipboardList,
  factory: IconBuildingFactory2,
  manufacturing_orders: IconClipboardList,
  work_centers: IconBuildingFactory2,
  work_orders: IconTools,
  quality_control: IconShieldCheck,
  icontool: IconTool,
  icontools: IconTools,
