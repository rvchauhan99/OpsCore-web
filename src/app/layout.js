...
export const metadata = {
  title: {
    default: "OpsCore Manufacturing ERP",
    template: "%s | OpsCore",
  },
  description:
    "OpsCore Manufacturing ERP — Bill of Materials, Work Orders, Production Scheduling, Quality Control, and more.",
};
...
export default function RootLayout({ children }) {
  return (
    <html lang="en" className={manrope.variable}>
      <head>
        <meta name="apple-mobile-web-app-title" content="OpsCore" />
      </head>
      <body
